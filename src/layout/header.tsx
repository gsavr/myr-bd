...
export function Header() {
  return (
    <div className="z-10 mb-36  flex w-full  items-center justify-between pt-2  text-3xl lg:mb-2 lg:flex lg:text-5xl">
      <div className="fixed left-0 top-0 flex !w-full flex-col items-center justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-2 pt-0 backdrop-blur-2xl lg:static lg:w-auto lg:border lg:bg-gray-200 lg:p-4  lg:pb-0 lg:drop-shadow-sm dark:border-neutral-800/15 dark:bg-zinc-800/30 dark:from-inherit lg:dark:bg-zinc-500/30">
